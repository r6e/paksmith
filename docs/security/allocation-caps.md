...
try_reserve_index(&mut buf, n, ctx, Some(SeamSite::*))?;   // lazy, microseconds
...
try_reserve_index(&mut entries, n, ctx, Some(SeamSite::FlatIndexEntries))?;  // lazy address-space reserve
for _ in 0..n {
