...
- **`FVirtualTextureDataChunk` header**: variable — 28 + 5 × NumLayers (UE 5.0+, with SHA prefix + `u32` CodecPayloadOffset) or 8 + 5 × NumLayers (UE 4.27, no SHA + `u32` offset) or 8 + 3 × NumLayers (pre-4.27, no SHA + `u16` offset).
